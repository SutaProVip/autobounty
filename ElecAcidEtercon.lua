...
getgenv().Setting = {
    ...
    ["Webhook"] = {
        ...
        ["ImageEmbed"] = true,
        ["CustomImage"] = true,
        ["CustomImageUrl"] = "https://media.discordapp.net/attachments/1209504229023289404/1217394936698114058/IMG_0049.jpg?ex=6603de63&is=65f16963&hm=a137352c41adf2f46d1fd0633b5d670cdde8dc46a3a885589e34450eb726fdf4&", --Your Url
        ["OnServerHop"] = true,
        ["BountyChanged"] = true,
    }, 
    ["Panel"] = false,
    ...
    ["Theme"] = {
        ["Name"] = "Ayaka",--"Old", "Raiden","Ayaka","Hutao","Yelan","Miko","Nahida","Ganyu","Keqing","Nilou","Barbara","Zhongli","Layla"
        ["Custom"] = {
            ["Enable"] = false,
    ...
    ["ChatKill"] = {
        Enable = true,
        Chat = {
            "so happy","so cute","so cool","so fun"
        },
    },
    ["Mention"] = {
        ["Enable"] = false,
